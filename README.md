...
>
> This language pack is maintained by the community. Anyone can translate through [Weblate](https://weblate.rob006.net/languages/hy/flarum2/) and no one verifies contributed translations. If you want to help maintain this package, you can contact us in [this discussion](https://discuss.flarum.org/d/27519-the-flarum-language-project).
...
This language pack contains Armenian translations for Flarum (compatible with `2.0.0` or newer) and popular extensions. Full list of supported extensions is available below.
...
```console
composer require "flarum-lang/armenian:@dev"
```
